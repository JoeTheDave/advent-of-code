...
export const solutionOne = () => {
  ...
  // NOTE: Haven't yet figured out part 2 of this puzzle and part 1 code is not returning
  // the correct answer anymore.  This entire problem needs to be reworked.
